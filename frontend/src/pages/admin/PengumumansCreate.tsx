    ...
    <div className="max-w-6xl mx-auto pb-20">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black text-gray-800 tracking-tight flex items-center gap-3">
              ...
              <span className={`px-2 py-0.5 text-[10px] uppercase font-bold rounded-full border ${formData.priority === 'high' ? 'bg-red-50 text-red-600 border-red-100' : 'bg-primary/10 text-primary border-primary/20'}`}>
                {formData.priority === 'high' ? 'Urgent' : 'General'}
              </span>
            </h1>
            <p className="text-xs text-gray-400 font-medium mt-1">Publikasikan informasi penting ke seluruh platform</p>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 space-y-8">
            <div className="space-y-4">
              ...
              <input 
                ...
                placeholder="Contoh: Pemberitahuan Libur Akhir Semester"
        ...
        <aside className="w-full lg:w-80 space-y-6">
          ...
          {/* Info Card */}
          <div className="bg-primary/5 rounded-3xl p-6 border border-primary/10 border-dashed text-center">
             <p className="text-[10px] text-primary/60 font-medium px-4 leading-relaxed">
                Pengumuman yang diterbitkan akan langsung muncul di halaman utama dan menu pengumuman publik.
             </p>
          </div>
        </aside>
      </div>
